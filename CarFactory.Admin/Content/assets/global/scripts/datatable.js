            ...
            options = $.extend(true, {
                ...
                dataTable: {
                    ...
                    "language": { // language settings
                        ...
                        "metronicAjaxRequestGeneralError": "无法完成请求,请检查网络连接!",
...
//                        { "name": "ViewDetailUrlTag","targets":5},
                    ...
                    "ajax": { // define ajax settings
                        ...
                        "data": function(data) { // add request parameters before submit
                            the.setAjaxParam('_token',$('input[name="_token"]').val());
        ...
        resetFilter: function() {
            // $('.filter:first textarea.form-filter, select.form-filter, input.form-filter', table).each(function() {
            //     $(this).val("");
            // });

            $('.filter:first .form-control:input').each(function(){
                $(this).val("");
            })
