...
using CarFactory.Admin.Controllers.Results;
using CarFactory.Admin.Models;
using CarFactory.Admin.Models.Account;
...
namespace CarFactory.Admin.Controllers
{
    ...
    public class AccountController : CarFactoryControllerBase
    {
        ...
        public AccountController(
            ...
            IUserNavigationManager userNavigationManager):base(userNavigationManager)
        {
