...
namespace NbscwMPACarFactory.Migrations.SeedData
{
    public class TenantRoleAndUserBuilder
    {
        private readonly NbscwMPADbContext _context;
        private readonly int _tenantId;

        public TenantRoleAndUserBuilder(NbscwMPADbContext context, int tenantId)
        {
            _context = context;
            _tenantId = tenantId;
        }
        ...
        private void CreateRolesAndUsers()
        {
            ...
            if (adminRole == null)
            {
                ...
                var permissions = PermissionFinder
                    .GetAllPermissions(new NbscwMPAAuthorizationProvider())
